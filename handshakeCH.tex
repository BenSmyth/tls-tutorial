...
\ifPresentationNotes
\marginpar{Maybe customise use of \texttt{lstinline}, which is wrapped inside 
  command \texttt{code} (defined in \texttt{main-tls-intro.tex}), to improve inline code listings.\\
  \textbf{Dear \LaTeX\ guru}, Please fix this, it will make reading this manuscript
  far easier for you (and everyone else). Please also fix other presentational/formatting issues.}
\fi
